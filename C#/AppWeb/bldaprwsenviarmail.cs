...
using System.IO;
public class bldaprwsenviarmail : GxBaseBuilder
{
   string cs_path = "." ;
   public bldaprwsenviarmail( ) : base()
   {
   }
   ...
   {
      bldaprwsenviarmail x = new bldaprwsenviarmail() ;
      x.SetMainSourceFile( "aprwsenviarmail.cs");
